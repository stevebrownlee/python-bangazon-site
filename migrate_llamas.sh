...
python manage.py loaddata customer.json producttype.json paymenttype.json product.json order.json  #loads the data from each .json file in sequential order.