...
python manage.py loaddata user.json profile.json category.json product.json order.json payment_type.json product_order.json   #loads the data from each .json file in sequential order.